...
namespace Classes
{
    public class commandesDAO
    {
        ...
        {
            connect.Open();
            SqlCommand requete = new SqlCommand("select * from commandes", connect);
            ...
            while (lecture.Read())
            {
                ...
                com.paiement_a_la_commade = Convert.ToBoolean(lecture["paiement_a_la_commade"]);
        ...
        {
            connect.Open();
            SqlCommand requete = new SqlCommand("select * from client where num_commande=@id", connect);
